...
public class TravelAdvisorGenerateInterlineSalesReport extends BorderPane {

    public TravelAdvisorGenerateInterlineSalesReport(Stage stage, String startDate, String endDate) {
        // Create Title Text
        Label pageTitle = new Label(startDate + " - " + endDate + " Personal Interline Sales Report");
        ...
        GlobalInterlineSalesReport report1 = DBMethods.PersonalInterlineSalesReport(startDate, endDate);
        ...
        saveButton2.setOnAction(e -> {
            ...
            if (file != null) {
                try {
                    ...
                    ObservableList<TravelAdvisorGenerateInterlineSalesReport.GlobalInterlineSalesReport> data = table.getItems();
                    for (TravelAdvisorGenerateInterlineSalesReport.GlobalInterlineSalesReport row : data) {
