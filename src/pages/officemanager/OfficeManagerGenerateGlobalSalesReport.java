...
public class OfficeManagerGenerateGlobalSalesReport extends BorderPane {

    public OfficeManagerGenerateGlobalSalesReport(Stage stage, String startDate, String endDate) {
        // Create Title Text
        ...
        ObservableList<OfficeManagerGenerateGlobalSalesReport.GlobalInterlineSalesReport> reportList = FXCollections.observableArrayList();
        OfficeManagerGenerateGlobalSalesReport.GlobalInterlineSalesReport report1 = DBMethods.GlobalInterlineSalesReport(startDate, endDate);
        ...
        saveButton2.setOnAction(e -> {
            ...
            if (file != null) {
                try {
                    ...
                    ObservableList<OfficeManagerGenerateGlobalSalesReport.GlobalInterlineSalesReport> data = table.getItems();
                    for (OfficeManagerGenerateGlobalSalesReport.GlobalInterlineSalesReport row : data) {
